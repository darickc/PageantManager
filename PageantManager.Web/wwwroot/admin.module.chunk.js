...
var garments_component_1 = __webpack_require__("../../../../../src/app/admin/garments/garments.component.ts");
var garment_component_1 = __webpack_require__("../../../../../src/app/admin/garment/garment.component.ts");
var routes = [
    {
        path: '',
        children: [
            ...
            },
            {
                ...
                component: garments_component_1.GarmentsComponent,
                data: { title: 'Garments' }
            }
        ]
    }
    ...
    AdminModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                ...
                garments_component_1.GarmentsComponent,
                garment_component_1.GarmentComponent
            ],
...
var GarmentTypeComponent = /** @class */ (function () {
    function GarmentTypeComponent(garmentTypesService, measurementTypesService, router, route, _fb, snackBar) {
    ...
    GarmentTypeComponent.prototype.ngOnInit = function () {
        ...
        this.measurementTypesService.getMeasurementTypes()
            ...
            _this.measurementTypes = mt;
            _this.subscribeToParams();
        });
    };
    GarmentTypeComponent.prototype.subscribeToParams = function () {
        var _this = this;
        this.route.params.subscribe(function (params) {
            if (params.id === 'new') {
                _this.newGarmentType = true;
                _this.garmentType = new shared_1.GarmentType({
                    garmentMeasurementTypes: []
                });
                _this.form.reset();
                _this.updateMeasurementOptions();
            }
            else {
                _this.loading = true;
    ...
    GarmentTypeComponent.prototype.submit = function () {
        ...
        for (var _i = 0, _a = gt.measurementOptions; _i < _a.length; _i++) {
            var mo = _a[_i];
            var index = _.findIndex(gt.garmentMeasurementTypes, { measurementTypeId: mo.measurementType.measurementTypeId });
            if (mo.selected) {
                if (index === -1) {
                    gt.garmentMeasurementTypes.push(new shared_1.GarmentMeasurementType({
        ...
        this.garmentTypesService.updateGarmentType(this.form.value)
            ...
            .subscribe(function (garmentType) {
            _this.setGarmentType(garmentType);
            _this.snackBar.open(garmentType.name + " saved!", 'Ok', { duration: 1000 });
        });
    };
    ...
    GarmentTypeComponent.prototype.updateMeasurementOptions = function () {
        while (this.measurementOptions.controls.length > 0) {
            this.measurementOptions.removeAt(0);
        }
        for (var _i = 0, _a = this.measurementTypes; _i < _a.length; _i++) {
            var t = _a[_i];
            var selected = _.findIndex(this.garmentType.garmentMeasurementTypes, { measurementTypeId: t.measurementTypeId }) > -1;
            var c = this._fb.group({
                selected: [selected],
    ...
    GarmentTypeComponent.prototype.deletePhoto = function () {
...
/***/ "../../../../../src/app/admin/garment/garment.component.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/admin/garment/garment.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var forms_1 = __webpack_require__("../../../forms/esm5/forms.js");
var shared_1 = __webpack_require__("../../../../../src/app/shared/index.ts");
var GarmentComponent = /** @class */ (function () {
    ...
    GarmentComponent.prototype.getGarmentMeasurementForm = function () {
        return this.fb.group({
            ...
            max: ['', [forms_1.Validators.required]]
        });
    };
    GarmentComponent.prototype.resetForm = function () {
        var formArray = this.form.controls.garmentMeasurements;
        ...
        if (this.garmentType) {
            ...
            for (var _i = 0, _a = this.garmentType.garmentMeasurementTypes; _i < _a.length; _i++) {
                var gmt = _a[_i];
    ...
    GarmentComponent.prototype.fileSelected = function (file) {
        this.form.controls.photo.setValue(file.content);
    };
    GarmentComponent.prototype.deletePhoto = function () {
        this.form.controls.photo.reset();
    };
    ...
    GarmentComponent.prototype.cancel = function () {
        this.editing = false;
    };
    __decorate([
        core_1.Input(),
        __metadata("design:type", shared_1.Garment)
    ], GarmentComponent.prototype, "garment", void 0);
    __decorate([
        core_1.Input(),
    ...
    GarmentComponent = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("../../../../../src/app/admin/garment/garment.component.html"),
            styles: [__webpack_require__("../../../../../src/app/admin/garment/garment.component.scss")]
        }),
        __metadata("design:paramtypes", [shared_1.GarmentsService, forms_1.FormBuilder])
    ], GarmentComponent);
    return GarmentComponent;
}());
exports.GarmentComponent = GarmentComponent;
...
/***/ "../../../../../src/app/admin/garments/garments.component.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/admin/garments/garments.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var material_1 = __webpack_require__("../../../material/esm5/material.es5.js");
var services_1 = __webpack_require__("../../../../../src/app/shared/services/index.ts");
var GarmentsComponent = /** @class */ (function () {
    function GarmentsComponent(garmentTypesService, router, route, _fb, snackBar) {
        this.garmentTypesService = garmentTypesService;
        this.router = router;
        this.route = route;
        this._fb = _fb;
    ...
    GarmentsComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    GarmentsComponent = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("../../../../../src/app/admin/garments/garments.component.html"),
            styles: [__webpack_require__("../../../../../src/app/admin/garments/garments.component.scss")]
        }),
        __metadata("design:paramtypes", [services_1.GarmentTypesService,
            router_1.Router,
            router_1.ActivatedRoute,
    ...
    return GarmentsComponent;
}());
exports.GarmentsComponent = GarmentsComponent;
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__("../../../../../src/app/shared/services/index.ts"));
__export(__webpack_require__("../../../../../src/app/shared/models/index.ts"));


/***/ }),

/***/ "../../../../../src/app/shared/models/costume-garment.ts":
/***/ (function(module, exports, __webpack_require__) {

"use strict";

Object.defineProperty(exports, "__esModule", { value: true });
var CostumeGarment = /** @class */ (function () {
    function CostumeGarment() {
    }
    return CostumeGarment;
}());
exports.CostumeGarment = CostumeGarment;


/***/ }),

/***/ "../../../../../src/app/shared/models/costume.ts":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/shared/models/garment-measurement-type.ts":
/***/ (function(module, exports, __webpack_require__) {

"use strict";

Object.defineProperty(exports, "__esModule", { value: true });
var GarmentMeasurementType = /** @class */ (function () {
    function GarmentMeasurementType(init) {
        Object.assign(this, init);
    }
    return GarmentMeasurementType;
}());
exports.GarmentMeasurementType = GarmentMeasurementType;


/***/ }),

/***/ "../../../../../src/app/shared/models/garment-measurement.ts":
/***/ (function(module, exports, __webpack_require__) {

"use strict";

Object.defineProperty(exports, "__esModule", { value: true });
var GarmentMeasurement = /** @class */ (function () {
    function GarmentMeasurement() {
    }
    return GarmentMeasurement;
}());
exports.GarmentMeasurement = GarmentMeasurement;


/***/ }),

/***/ "../../../../../src/app/shared/models/garment-type.ts":
/***/ (function(module, exports, __webpack_require__) {

"use strict";

Object.defineProperty(exports, "__esModule", { value: true });
var GarmentType = /** @class */ (function () {
    function GarmentType(init) {
        Object.assign(this, init);
    }
    return GarmentType;
}());
exports.GarmentType = GarmentType;


/***/ }),

/***/ "../../../../../src/app/shared/models/garment.ts":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__("../../../../../src/app/shared/models/costume-garment.ts"));
__export(__webpack_require__("../../../../../src/app/shared/models/costume.ts"));
__export(__webpack_require__("../../../../../src/app/shared/models/garment-measurement-type.ts"));
__export(__webpack_require__("../../../../../src/app/shared/models/garment-measurement.ts"));
__export(__webpack_require__("../../../../../src/app/shared/models/garment-type.ts"));
__export(__webpack_require__("../../../../../src/app/shared/models/garment.ts"));
__export(__webpack_require__("../../../../../src/app/shared/models/measurement-option.ts"));
__export(__webpack_require__("../../../../../src/app/shared/models/measurement-type.ts"));
__export(__webpack_require__("../../../../../src/app/shared/models/measurement.ts"));
__export(__webpack_require__("../../../../../src/app/shared/models/picked-file.ts"));
__export(__webpack_require__("../../../../../src/app/shared/models/read-mode.ts"));


/***/ }),

/***/ "../../../../../src/app/shared/models/measurement-option.ts":
/***/ (function(module, exports, __webpack_require__) {

"use strict";

Object.defineProperty(exports, "__esModule", { value: true });
var MeasurementOption = /** @class */ (function () {
    function MeasurementOption() {
    }
    return MeasurementOption;
}());
exports.MeasurementOption = MeasurementOption;


/***/ }),

/***/ "../../../../../src/app/shared/models/measurement-type.ts":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/shared/models/measurement.ts":
/***/ (function(module, exports, __webpack_require__) {
